...
project = u'Plone Community Managed Developer Manual'
copyright = u'2010 mFabrik Research Oy and Plone community contributors'
...
latex_documents = [
  ('index', 'PloneDeveloperManual.tex', u'Plone Developer Manual Documentation',
   u'mFabrik Research Oy and Plone community', 'manual'),
]
