...
If you use direct attribute access, i.e. ``obj.something`` you can get a `BaseUnit <http://svn.plone.org/svn/archetypes/Products.Archetypes/trunk/Products/Archetypes/BaseUnit.py>`_ object.
