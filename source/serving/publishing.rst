...
* A widget to make specified files downloadable: `plone.formwidgets.namedfile.widget <http://svn.plone.org/svn/plone/plone.formwidget.namedfile/trunk/plone/formwidget/namedfile/widget.py>`_.
