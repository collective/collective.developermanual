...
* When writing the ``GenericSetup`` XML of your type, follow the example of `Image.xml <http://svn.plone.org/svn/plone/Plone/branches/3.3/Products/CMFPlone/profiles/default/types/Image.xml>`_.
